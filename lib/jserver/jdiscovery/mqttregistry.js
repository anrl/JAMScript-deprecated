    ...
    this.client.on('message', function (topic, message, packet) {
        ...
        if (message.toString() === '') {
            ...
            if (eventName !== undefined) {
                ...
                console.log('event name is undefined for machine type ' + machType + ' and attribute ' + attr + ' - this may be because we are still awaiting a subscription confirmation for the associated attribute');
            }
            return;
        }
